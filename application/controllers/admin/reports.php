                    ...
                    foreach($post->incident_id as $item)
                    {
                        ...
                        if ($update->loaded == true) 
                        {
                            ...
                            if (!empty($update->incident_person->person_email))
                            {
                              ...
                              $message .= "See it now: ".url::site('reports/view/'.$update->id)."\n\n Add another idea and show your friends: http://www.pps.org/placemap/sanantonio/\n\n Want to know more about what makes a place great? Start with these two stories:\n\n What Makes a Successful Place? After evaluating thousands of public spaces around the world, Project for Public Spaces found that successful places have four key qualities. http://pps.org/grplacefeat/\n\n The Power of Ten offers an easy framework to revitalize urban life. http://pps.org/the-power-of-10/\n\n Thank you,\n\n The Digital Placemaking Team at PPS\n";
